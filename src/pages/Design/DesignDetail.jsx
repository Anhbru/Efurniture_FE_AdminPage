...
const DesignDetail = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8080/api/v1/designs/get-by-id/${id}`)
      .then((response) => {
              ...
              <div className="page-title-right">
                <ol className="breadcrumb m-0">
                  <li className="breadcrumb-item">
                    <a href="javascript: void(0);">Project Booking</a>
                  </li>
                  <li className="breadcrumb-item">
                    <a href="javascript: void(0);">Design List</a>
                  </li>
                      ...
                      <div className="dash__pad-2">
                        ...
                        {designDetail && (
                          <div className="m-order__list">
                                ...
                                <div className="description__info-wrap">
                                  ...
                                  <div>
                                    <span className="manage-o__text-2 u-c-silver">
                                      Note: {designDetail.note}{" "}
                                      <span className="manage-o__text-2 u-c-secondary"></span>
                                    </span>
                                  </div>
                                </div>
                              </div>
                            ...
                            <embed
                              src={`data:application/pdf;base64,${designDetail.fileData}`}
