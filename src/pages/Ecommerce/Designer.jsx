  ...
  const fetchDesigner = async () => {
    try {
      const response = await axios.get(
        `http://localhost:8080/api/v1/get-all-designer`,
        {
          params: {
                          ...
                          return (
                            <tr key={index}>
                              ...
                              <td className="table-user">
                                ...
                                >
                                  {designerItem.fullName}
                                </a>
                              </td>
                              <td>{designerItem.phoneNumber}</td>
                              <td>{designerItem.email}</td>
                              <td>Việt Nam</td>
                              <td>{designerItem.dateOfBirth}</td>
                              <td>
                                <span className="badge badge-success-lighten">
                                  {designerItem.active ? "active" : ""}
                                </span>
                              </td>
                              <td>
                                <a
