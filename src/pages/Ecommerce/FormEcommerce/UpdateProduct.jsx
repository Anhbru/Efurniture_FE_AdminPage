  ...
  const handleImageUpload = async (event, index) => {
    ...
    if (file) {
      ...
      updatedProductImages[index] = {
        id: updatedProductImages[index].id,
                    ...
                    <div className="row">
                      <div className="col-xl-6">
                        ...
                        >
                          ...
                          <option value="0" selected={values.status === "0"}>
                            In-Active
                          </option>
                        </select>
                        {/* Category */}
                      ...
                      <div className="col-xl-6">
                        ...
                        <div className="mb-0">
                          ...
                          <select
                            value={selectedTagProduct.id}
                            onChange={handleTagProductChange}
                            className={`form-control select2 ${
                              tagError ? "is-invalid" : ""
                            }`}
                            data-toggle="select2"
                          >
                            ...
                            {tagProduct &&
                              ...
                              tagProduct.map((tagProductItem, index) => {
                                return (
                                  <option
                                    key={tagProductItem.id}
                                    value={tagProductItem.id}
                                  >
                                    {tagProductItem.name}
                                  </option>
                                );
