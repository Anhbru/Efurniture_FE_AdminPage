              ...
              <div className="card-body">
                <div className="row mb-2">
                  <div className="col-sm-5">
                    <a href="/create-product" className="btn btn-danger mb-2">
                      <i className="mdi mdi-plus-circle me-2" /> Add Products
                    </a>
                  </div>
                        ...
                        products.map((productsItem, index) => {
                          return (
                            <tr key={index}>
                              ...
                              <td>{productsItem.category_id.name}</td>
                              <td>{productsItem.created_at}</td>
                              <td>${productsItem.price}</td>
                              <td>{productsItem.quantity}</td>
                              <td>
                              ...
                              <td className="table-action">
                                <Link
                                  to={`/product-detail/${productsItem.id}`}
                                ...
                                <Link
                                  to={`/update-product/${productsItem.id}`}
                                  className="action-icon"
                                >
