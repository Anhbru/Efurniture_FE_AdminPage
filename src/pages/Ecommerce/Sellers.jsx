                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div
                            className="spark-chart"
                            data-dataset="[25, 66, 41, 45, 63, 25, 66, 12, 45, 9, 54]"
                          />
                        </td>
                        <td>
                          <a href="javascript:void(0);" className="action-icon">
                      ...
                      <tr>
                        ...
                        <td>
                          <div
                            className="spark-chart"
                            data-dataset="[25, 66, 41, 34, 63, 25, 34, 12, 434, 9, 54]"
                          />
                        </td>
                        <td>
                          <a href="javascript:void(0);" className="action-icon">
                      ...
                      <tr>
                        ...
                        <td>
                          <div
                            className="spark-chart"
                            data-dataset="[25, 66, 41, 34, 33, 25, 34, 50, 65, 9, 54]"
                          />
                        </td>
                        <td>
                          <a href="javascript:void(0);" className="action-icon">
                      ...
                      <tr>
                        ...
                        <td>
                          <div
                            className="spark-chart"
                            data-dataset="[25, 66, 45, 34, 33, 34, 34, 50, 55, 9, 54]"
                          />
                        </td>
                        <td>
                          <a href="javascript:void(0);" className="action-icon">
                      ...
                      <tr>
                        ...
                        <td>
                          <div
                            className="spark-chart"
                            data-dataset="[25, 66, 30, 67, 33, 25, 34, 56, 65, 9, 54]"
                          />
                        </td>
                        <td>
                          <a href="javascript:void(0);" className="action-icon">
                      ...
                      <tr>
                        ...
                        <td>
                          <div
                            className="spark-chart"
                            data-dataset="[25, 66, 30, 45, 33, 25, 44, 56, 33, 9, 33]"
                          />
                        </td>
                        <td>
                          <a href="javascript:void(0);" className="action-icon">
                      ...
                      <tr>
                        ...
                        <td>
                          <div
                            className="spark-chart"
                            data-dataset="[25, 43, 30, 67, 34, 25, 34, 56, 43, 9, 56]"
                          />
                        </td>
                        <td>
                          <a href="javascript:void(0);" className="action-icon">
                      ...
                      <tr>
                        ...
                        <td>
                          <div
                            className="spark-chart"
                            data-dataset="[25, 23, 30, 67, 34, 56, 34, 56, 85, 9, 56]"
                          />
                        </td>
                        <td>
                          <a href="javascript:void(0);" className="action-icon">
                      ...
                      <tr>
                        ...
                        <td>
                          <div
                            className="spark-chart"
                            data-dataset="[25, 82, 30, 67, 65, 25, 34, 56, 44, 9, 22]"
                          />
                        </td>
                        <td>
                          <a href="javascript:void(0);" className="action-icon">
                      ...
                      <tr>
                        ...
                        <td>
                          <div
                            className="spark-chart"
                            data-dataset="[25, 54, 30, 44, 65, 25, 34, 33, 44, 9, 23]"
                          />
                        </td>
                        <td>
                          <a href="javascript:void(0);" className="action-icon">
                      ...
                      <tr>
                        ...
                        <td>
                          <div
                            className="spark-chart"
                            data-dataset="[25, 82, 23, 67, 65, 67, 65, 56, 32, 19, 22]"
                          />
                        </td>
                        <td>
                          <a href="javascript:void(0);" className="action-icon">
