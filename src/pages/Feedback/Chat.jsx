            ...
            <div className="card">
              <div className="card-body p-0">
                ...
                <div className="tab-content">
                  <div
                    className="tab-pane show active card-body pb-0"
                    id="newpost"
                  >
                    {/* start search box */}
          ...
          <div className="col-xxl-6 col-xl-12 order-xl-2">
            <div className="card">
              <div className="card-body px-0 pb-0">
                <ul
                  className="conversation-list px-3"
                  data-simplebar
                  style={{ maxHeight: 538 }}
                >
              ...
              <div className="card-body">
                ...
                <div className="mt-3">
                  ...
                  <p className="mt-4 mb-1">
                    <strong>
                      <i className="uil uil-at" /> Email:
                    </strong>
                  </p>
                  <p>support@coderthemes.com</p>
                  <p className="mt-3 mb-1">
                    <strong>
                      <i className="uil uil-phone" /> Phone Number:
                    </strong>
                  </p>
                  <p>+1 456 9595 9594</p>
                  <p className="mt-3 mb-1">
                    <strong>
                      <i className="uil uil-location" /> Location:
                    </strong>
                  </p>
                  <p>California, USA</p>
                  <p className="mt-3 mb-1">
                    <strong>
                      <i className="uil uil-globe" /> Languages:
                    </strong>
                  </p>
                  <p>English, German, Spanish</p>
                  <p className="mt-3 mb-2">
                    <strong>
                      <i className="uil uil-users-alt" /> Groups:
                    </strong>
                  </p>
                  <p>
                    <span className="badge badge-success-lighten p-1 font-14">
                      Work
                    </span>
                    <span className="badge badge-primary-lighten p-1 font-14">
                      Friends
                    </span>
                  </p>
                </div>
