...
import {
  DataTotalDay,
  DataTop5Product,
} from "../services/AnalysisApi/AnalysisApi";
            ...
            <div className="col-lg-8">
              <div className="card">
                <div className="card-body">
                  ...
                  <div
                    className="dash-item-overlay d-none d-md-block"
                    dir="ltr"
                  >
                ...
                <div className="card-body">
                  ...
                  <div className="table-responsive">
                    <table className="table table-centered table-nowrap table-hover mb-0">
                      <tbody>
                        {dataTop5Product &&
                          dataTop5Product.length > 0 &&
                          dataTop5Product.map((dataTop5ProductItem, index) => {
                            return (
                              <tr key={index}>
                                <td>
                                  <h5 className="font-14 my-1 fw-normal">
                                    {dataTop5ProductItem.product.name}
                                  </h5>
                                  <span className="text-muted font-13">
                                    {dataTop5ProductItem.product.createdAt}
                                  </span>
                                </td>
                                <td>
                                  <h5 className="font-14 my-1 fw-normal">
                                    ${dataTop5ProductItem.product.price}
                                  </h5>
                                  <span className="text-muted font-13">
                                    Price
                                  </span>
                                ...
                                <td>
                                  <h5 className="font-14 my-1 fw-normal">
                                    {dataTop5ProductItem.totalQuantitySold}
                                  </h5>
                                  <span className="text-muted font-13">
                                    Quantity
                                  </span>
                                ...
                                <td>
                                  <h5 className="font-14 my-1 fw-normal">
                                    ${dataTop5ProductItem.totalAmountSold}
                                  </h5>
                                  <span className="text-muted font-13">
                                    Amount
                                  </span>
